 ...
 * @ingroup print
 */
$toc_block = module_invoke('views', 'block_view', 'all_chapters_for_print-block_1');
$resources_block = module_invoke('views', 'block_view', 'resources-block');
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  <head>
    ...
    <?php endif; ?>
    <?php print $css; ?>
    <link type="text/css" rel="stylesheet" href="/sites/default/files/color/footheme-a5b81af9/colors.css" />
  </head>
  <body class="print-page">
    ...
    <?php endif; ?>
    <?php if ($toc_block) : ?>
                <div class="print-blocks toc"><h2 class="block-title">Table of Contents</h2><?php print render($toc_block['content']); ?></div>
    <?php endif; ?>
    <div class="print-content"><?php print $content; ?></div>
    <?php if ($resources_block) : ?>
		<div class="print-blocks resources"><h2 class="block-title">Resources by Case Study</h2><?php print render($resources_block['content']); ?></div>
    <?php endif; ?>
